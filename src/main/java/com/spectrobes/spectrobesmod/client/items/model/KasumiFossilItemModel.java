...
public class KasumiFossilItemModel extends AnimatedGeoModel<KasumiFossilItem> {
    ...
    @Override
    public ResourceLocation getModelLocation(KasumiFossilItem aoiFossilItem) {
        return new ResourceLocation(SpectrobesInfo.MOD_ID, "geo/blocks/kasumi.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(KasumiFossilItem aoiFossilItem) {
        return new ResourceLocation(SpectrobesInfo.MOD_ID, "textures/models/blocks/fossil.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(KasumiFossilItem aoiFossilItem) {
        return null;
    }
}
