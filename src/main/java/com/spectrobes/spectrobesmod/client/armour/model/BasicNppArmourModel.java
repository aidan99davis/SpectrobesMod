...
public class BasicNppArmourModel extends GeoModel<BasicNppArmourItem> {
    @Override
    public ResourceLocation getModelResource(BasicNppArmourItem object) {
        return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "geo/armour/basic.geo.json");
    }
