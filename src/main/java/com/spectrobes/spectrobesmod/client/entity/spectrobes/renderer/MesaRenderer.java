...
public class MesaRenderer extends GeoEntityRenderer<EntityMesa> {
    ...
    public ResourceLocation getTextureLocation(EntityMesa entity)
    {
        switch (entity.getSpectrobeData().Variant) {
            ...
            case 1:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "textures/models/spectrobe/mesa_1.png");
            case 2:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "textures/models/spectrobe/mesa_2.png");
            default:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "textures/models/spectrobe/mesa_0.png");
