...
public class MasettoModel extends GeoModel<EntityMasetto> {

	@Override
	public ResourceLocation getModelResource(EntityMasetto object)
	{
		return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "geo/masetto.geo.json");
	}
	...
	{
		return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "animations/spectrobe/masetto.json");
	}
}