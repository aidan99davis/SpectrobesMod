...
public class VilamastaRenderer extends GeoEntityRenderer<EntityVilamasta> {
    ...
    public ResourceLocation getTextureLocation(EntityVilamasta entity)
    {
        return switch (entity.getSpectrobeData().Variant) {
            case 1 -> ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "textures/models/spectrobe/vilamasta_1.png");
            case 2 -> ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "textures/models/spectrobe/vilamasta_2.png");
            default -> ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "textures/models/spectrobe/vilamasta_0.png");
        };
    }
