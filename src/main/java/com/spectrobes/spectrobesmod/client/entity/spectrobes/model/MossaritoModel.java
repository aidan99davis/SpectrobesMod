...
public class MossaritoModel extends GeoModel<EntityMossarito> {

	@Override
	public ResourceLocation getModelResource(EntityMossarito object)
	{
		return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "geo/mossarito.geo.json");
	}
	...
	{
		return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "animations/spectrobe/mossarito.json");
	}
}