...
public class SegulosRenderer extends GeoEntityRenderer<EntitySegulos> {
    ...
    public ResourceLocation getTextureLocation(EntitySegulos entity)
    {
        switch (entity.getSpectrobeData().Variant) {
            ...
            case 1:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/segulos_1.png");
            case 2:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/segulos_2.png");
            default:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/segulos_0.png");
