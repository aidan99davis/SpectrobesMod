...
public class BartorModel extends GeoModel<EntityBartor> {

	@Override
	public ResourceLocation getModelResource(EntityBartor object)
	{
		return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "geo/bartor.geo.json");
	}
	...
	{
		return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID, "animations/spectrobe/bartor.json");
	}
}