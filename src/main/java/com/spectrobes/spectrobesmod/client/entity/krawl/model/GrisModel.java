...
public class GrisModel extends AnimatedGeoModel<EntityGris> {
	...
	@Override
	public ResourceLocation getModelLocation(EntityGris object)
	{
		return new ResourceLocation(SpectrobesInfo.MOD_ID, "geo/gris.geo.json");
	}

	@Override
	public ResourceLocation getTextureLocation(EntityGris object)
	{
		return new ResourceLocation(SpectrobesInfo.MOD_ID, "textures/models/krawl/gris.png");
	}

	@Override
	public ResourceLocation getAnimationFileLocation(EntityGris object)
	{
