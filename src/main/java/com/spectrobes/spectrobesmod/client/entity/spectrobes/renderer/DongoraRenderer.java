...
public class DongoraRenderer extends GeoEntityRenderer<EntityDongora> {
    ...
    public ResourceLocation getTextureLocation(EntityDongora entity)
    {
        switch (entity.getSpectrobeData().Variant) {
            ...
            case 1:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/dongora_1.png");
            case 2:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/dongora_2.png");
            default:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/dongora_0.png");
