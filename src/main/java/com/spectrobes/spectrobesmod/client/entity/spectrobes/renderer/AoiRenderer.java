...
public class AoiRenderer extends GeoEntityRenderer<EntityAoi> {
    ...
    public ResourceLocation getTextureLocation(EntityAoi entity)
    {
        switch (entity.getSpectrobeData().Variant) {
            ...
            case 1:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/aoi_1.png");
            case 2:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/aoi_2.png");
            default:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/aoi_0.png");
