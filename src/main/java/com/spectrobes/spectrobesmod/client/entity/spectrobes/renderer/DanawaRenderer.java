...
public class DanawaRenderer extends GeoEntityRenderer<EntityDanawa> {
    ...
    public ResourceLocation getTextureLocation(EntityDanawa entity)
    {
        switch (entity.getSpectrobeData().Variant) {
            ...
            case 1:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/danawa_1.png");
            case 2:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/danawa_2.png");
            default:
                return ResourceLocation.fromNamespaceAndPath(SpectrobesInfo.MOD_ID + ":textures/models/spectrobe/danawa_0.png");
