...
public class SeguFossilRenderer extends GeoBlockRenderer<SeguFossilBlockTileEntity> {
    ...
    public SeguFossilRenderer(BlockEntityRendererProvider.Context rendererDispatcherIn) {
        super(new SeguFossilModel());
    }

    @Override
    public void render(SeguFossilBlockTileEntity animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
