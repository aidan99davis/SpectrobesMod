...
//
    ...
    protected static void innerBlit(int x0, int x1, int y0, int y1, int z, float u0, float u1, float v0, float v1) {
        Tesselator lvt_9_1_ = Tesselator.getInstance();
        BufferBuilder lvt_10_1_ = lvt_9_1_.getBuilder();
        lvt_10_1_.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX);
...
//
//    public static void renderModel(BakedModel modelIn, ItemStack stack, int combinedLightIn, int combinedOverlayIn, PoseStack matrixStackIn, IVertexBuilder bufferIn) {
//        RandomSource random = new LegacyRandomSource(234523);
//        long i = 42L;
//
...
//    }
//
//    private static void renderQuads(PoseStack matrixStackIn, VertexBuffer bufferIn, List<BakedQuad> quadsIn, ItemStack itemStackIn, int combinedLightIn, int combinedOverlayIn) {
...
//    }
//
//    public static void renderBakedModel(BakedModel modelIn, ItemStack itemStackIn, RenderType renderTypeOverride, PoseStack matrixStackIn, IRenderTypeBuffer buffer)
//    {
...
//
//    @OnlyIn(Dist.CLIENT)
//    private static <T extends LivingRenderer<?, ?>, V extends LivingEntity> void invokePreRenderCallback(T rend, Class clz, V ent, PoseStack stack, float rendTick)
//    {
//        try
//        {
//            Method m = clz.getDeclaredMethod(ObfuscationReflectionHelper.remapName(INameMappingService.Domain.METHOD, ObfHelper.preRenderCallback), LivingEntity.class, PoseStack.class, float.class);
//            m.setAccessible(true);
