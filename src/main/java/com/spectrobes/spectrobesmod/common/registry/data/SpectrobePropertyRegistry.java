...
public class SpectrobePropertyRegistry {
    ...
    //INKANA LINE
    public static SpectrobeProperties INKANA = new SpectrobeProperties(SpectrobeProperties.Nature.CORONA, SpectrobeProperties.Stage.CHILD);
    ...
    public static SpectrobeProperties KUGANON = new SpectrobeProperties(SpectrobeProperties.Nature.AURORA, SpectrobeProperties.Stage.ADULT);
