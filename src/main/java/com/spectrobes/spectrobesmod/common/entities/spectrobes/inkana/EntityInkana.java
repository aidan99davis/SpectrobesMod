...
//        return SpectrobesEntities.ENTITY_DONGORA.get();
    ...
    public PlayState moveController(AnimationState<EntitySpectrobe> animationState) {
        ...
        {
            animationState.getController().setAnimation(new AnimationBuilder().addAnimation("animation.inkana.walk", ILoopType.EDefaultLoopTypes.LOOP));
            ...
            animationState.getController().setAnimation(new AnimationBuilder().addAnimation("animation.inkana.idle", ILoopType.EDefaultLoopTypes.LOOP));
            return PlayState.CONTINUE;
        }
    }
