...
//        return SpectrobesEntities.ENTITY_DONGIGA.get();
    ...
    public <ENTITY extends EntitySpectrobe> PlayState moveController(AnimationEvent<ENTITY> event) {
        if(event.isMoving())
        {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.dongora.walk", ILoopType.EDefaultLoopTypes.LOOP));
            ...
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.dongora.idle", ILoopType.EDefaultLoopTypes.LOOP));
            return PlayState.CONTINUE;
        }
    }
