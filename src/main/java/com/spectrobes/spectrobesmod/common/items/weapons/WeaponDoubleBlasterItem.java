...
import com.spectrobes.spectrobesmod.client.items.weapons.renderer.WeaponDoubleBlasterItemRenderer;
...
public class WeaponDoubleBlasterItem extends AbstractSpectrobesRangedWeapon {
    public WeaponDoubleBlasterItem(Properties pProperties) { super(pProperties); }
    ...
    // = = = VISUAL = = =
    @Override public String getControllerName() { return "weapon_double_blaster"; }
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private WeaponDoubleBlasterItemRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (this.renderer == null) {
                    this.renderer = new WeaponDoubleBlasterItemRenderer();
                }
