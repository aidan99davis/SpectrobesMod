...
import com.spectrobes.spectrobesmod.client.items.weapons.renderer.WeaponShatterBlasterItemRenderer;
...
public class WeaponShatterBlasterItem extends AbstractSpectrobesRangedWeapon {
    public WeaponShatterBlasterItem(Properties pProperties) { super(pProperties); }
    ...
    // = = = VISUAL = = =
    @Override public String getControllerName() { return "weapon_shatter_blaster"; }
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private WeaponShatterBlasterItemRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (this.renderer == null) {
                    this.renderer = new WeaponShatterBlasterItemRenderer();
                }
