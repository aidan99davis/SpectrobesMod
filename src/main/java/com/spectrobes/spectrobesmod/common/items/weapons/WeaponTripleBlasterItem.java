...
import com.spectrobes.spectrobesmod.client.items.weapons.renderer.WeaponTripleBlasterItemRenderer;
...
public class WeaponTripleBlasterItem extends AbstractSpectrobesRangedWeapon {
    public WeaponTripleBlasterItem(Properties pProperties) { super(pProperties); }
    ...
    // = = = VISUAL = = =
    @Override public String getControllerName() { return "weapon_triple_blaster"; }
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private WeaponTripleBlasterItemRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (this.renderer == null) {
                    this.renderer = new WeaponTripleBlasterItemRenderer();
                }
